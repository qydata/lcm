...
import {BROWSWE_URL} from "@hey/data/constants";
import logger from "@hey/helpers/logger";

import getRpc from "../../getRpc";
import sendSlackMessage from "../../slack";
import {ctchain} from "../../constants";
      ...
      fields: [
        {
          short: false,
          title: "Transaction",
          value: `${BROWSWE_URL}/tx/${hash}`
        },
        {
          short: false,
          title: "Profile",
          value: `https://lcm.xyz/u/${handle}`
        }
      ],
