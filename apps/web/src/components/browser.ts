 ...
 */
export function uint8arrayToString(uint8array: Uint8Array, encoding: string) {
 ...
 */
export function uint8arrayFromString(str: any, encoding: string) {
 ...
 * @returns {string} The data URL.  This is a string representation that can be used anywhere the original file would be used.
 */
export function downloadFile({filename, data, mimetype}: any) {
