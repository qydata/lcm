...
👍🎉 Thank you for your interest in contributing to Lcm! 🎉👍

Lcm is an open-source project maintained by [Yoginth](https://gitlab.com/yo). We appreciate your interest and efforts to contribute to Lcm.
...
Lcm is an open-source project. See the [LICENSE](https://gitlab.com/yo/hey/-/blob/main/LICENSE) file for licensing information. All the work done is available on GitLab.
