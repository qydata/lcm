...
import {HeyTipping} from "@lcm/abis";
import {
    APP_NAME,
...
import {Button, H6, HelpTooltip, Input, Select, Spinner} from "@lcm/ui";
...
const Action: FC<ActionProps> = ({
    ...
    const enableTipping = async () => {
        ...
        try {
            ...
            await writeContractAsync({
                ...
                args: [LCM_TIPPING, MAX_UINT256],
                functionName: "approve"
            });
            console.log(PUBLICATION.TIP.ENABLE, {
                address,
    ...
    const handleTip = async () => {
        ...
        try {
            ...
            console.log(PUBLICATION.TIP.TIP, {
                address,
                amount,
                currency: selectedCurrency?.symbol
            });
        ...
        return (
            <div className="m-5 space-y-3">
                ...
                <H6 className="ld-text-gray-500">
                    Switch to: {formatAddress(currentProfile?.ownedBy)}
                </H6>
            </div>
        );
    }
                        ...
                        <div className="py-1">
                            ...
                            <div className="flex items-start space-x-10">
                                <div className="flex items-center space-x-2">
                                    <img className="size-3" src={`logo.png`} alt="Logo"/>
                                    <span>{APP_NAME}</span>
                                </div>
                                <b>
