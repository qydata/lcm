  ...
  var Ie = j((te) => {
    ...
    function St(t, e) {
      ...
      let r = new Uint8Array(e),
        s = 0;
      for (const o of t) r.set(o, s), (s += o.length);
      return r;
    }
    te.concat = St;
  });
  ...
  var Pe,
    ...
    S = D(() => {
      (Pe = new Uint8Array(0)),
        ...
        (It = (t) => {
          const e = t.match(/../g);
          return e ? new Uint8Array(e.map((r) => Number.parseInt(r, 16))) : Pe;
        }),
        (se = (t, e) => {
          if (t === e) return !0;
          if (t.byteLength !== e.byteLength) return !1;
    ...
    g = D(() => {
      ...
      (Te = class {
        ...
        (B = ({ prefix: t, name: e, alphabet: r }) => {
          const { encode: s, decode: o } = qe(r, e);
  ...
  var h,
    ...
    ht = D(() => {
      ...
      (h = class {
        ...
        toString(e) {
          const { bytes: r, version: s, _baseCache: o } = this;
          switch (s) {
            case 0:
        ...
        static asCID(e) {
          ...
          if (e != null && e.asCID === e) {
            const { version: r, code: s, multihash: o, bytes: n } = e;
            return new h(r, s, o, n || ct(r, s, o.bytes));
          } else if (e != null && e[dt] === !0) {
            const { version: r, multihash: s, code: o } = e,
              n = Ee(s);
