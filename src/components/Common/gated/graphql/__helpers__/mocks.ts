...
import {
  ...
  type EncryptedFragmentOf,
  type EncryptedFragmentOfAnyPublicationMetadata,
...
export function mockRootCondition(
  overrides?: Partial<RootCondition>
): RootCondition {
  return {
    criteria: [],
    ...overrides,
...
export function mockAndCondition(
  overrides?: Partial<AndCondition>
): AndCondition {
  return {
    criteria: [],
    ...overrides,
...
export function mockCollectCondition(
  overrides?: Partial<CollectCondition>
): CollectCondition {
  return {
...
export function mockFollowCondition(
  overrides?: Partial<FollowCondition>
): FollowCondition {
  return {
...
export function mockNetworkAddress(
  overrides?: Partial<NetworkAddress>
): NetworkAddress {
  return {
