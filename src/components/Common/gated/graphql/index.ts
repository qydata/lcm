import type { Overwrite, Primitive } from "@lens-protocol/shared-kernel";

import type { Maybe, PublicationMetadata } from "./generated";
...
type FragmentWithTypename<ObjectType extends WithTypename> = PrettyIntersection<
  ...
  {
    [KeyType in keyof Omit<ObjectType, "__typename">]?: FragmentOf<
      ObjectType[KeyType]
    >;
  }
>;
 ...
 * @internal
 */
export type EncryptedFragmentOf<
  Metadata extends EncryptablePublicationMetadata<unknown>
 ...
 * Fragments must include `__typename` at all levels.
 */
export type EncryptedFragmentOfAnyPublicationMetadata =
  EncryptedFragmentOf<PublicationMetadata>;

/**
 * Any encryptable `PublicationMetadata` fragment.
 */
export type EncryptablePublicationMetadataFragment = Pick<
  PublicationMetadata,
  "encryptedWith"
>;
/**
