import type { Frame as IFrame } from "@lcm/types/misc";
...
import getNftChainId from "@lcm/helpers/getNftChainId";
import getNftChainInfo from "@lcm/helpers/getNftChainInfo";
import { Button, H4 } from "@lcm/ui";
      ...
      <div>
        ...
        <div className="flex items-center justify-between gap-x-10">
          ...
          <span className="ld-text-gray-500 truncate">
            {formatAddress(currentProfile?.ownedBy)}
          </span>
        </div>
      </div>
