import type { Profile, ProfileSearchRequest } from "@lcm/lens";
...
import { CustomFiltersType, useSearchProfilesLazyQuery } from "@lcm/lens";
...
const Search: FC<SearchProps> = ({ placeholder = "搜索…" }) => {
  ...
  const handleKeyDown = (evt: ChangeEvent<HTMLFormElement>) => {
    evt.preventDefault();
    console.log(SEARCH.SEARCH, { query: searchText });
    if (pathname === "/search") {
