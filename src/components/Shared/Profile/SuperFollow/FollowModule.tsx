...
import { BROWSWE_URL, LENS_HUB } from "@lcm/data/constants";
...
import getTokenImage from "@lcm/helpers/getTokenImage";
import type { FeeFollowModuleSettings, Profile } from "@lcm/lens";
import {
  FollowModuleType,
...
import { Button, H3, H5, Spinner, WarningMessage } from "@lcm/ui";
...
const FollowModule: FC<FollowModuleProps> = ({
  ...
  const onCompleted = (__typename?: "RelayError" | "RelaySuccess") => {
    ...
    console.log(PROFILE.SUPER_FOLLOW, {
      path: pathname,
      target: profile?.id
    });
  };
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="space-x-1.5">
          ...
          <Link
            ...
            href={`${BROWSWE_URL}/address/${followModule?.recipient}`}
