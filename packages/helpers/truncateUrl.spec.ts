...
describe("truncateUrl", () => {
  ...
  test("should not truncate *.lcm.xyz url", () => {
    const mainnetUrl = "https://lcm.xyz/long/pathname/test";
    expect(truncateUrl(mainnetUrl, 20)).toEqual("lcm.xyz/long/pathname/test");
  });
});
